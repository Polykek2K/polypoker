"""
Django settings for polypoker project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 's$ljy8f+gsvqe4$@@o6)tzis%=+r9)(+1is4x@dgwa1aceggn8')
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [os.environ.get('REDIS_URL', 'redis://redis_db:6379')],
        },
    },
}
